...
public struct SummariseConfig: Codable, Equatable {
    ...
    /// Both `server` and `local` are user-controlled Ollama endpoints. Seshat has
...
public struct Config: Codable, Equatable {
    ...
    public init(watchIntervalSeconds: Int = 20,
                recordingsDir: String = "~/Documents/Seshat/recordings",
                notesDir: String = "~/Documents/Seshat/notes",
                workDir: String = "~/Library/Application Support/Seshat/work",
    ...
    public static var dataBaseDir: URL {
        FileManager.default.homeDirectoryForCurrentUser
            .appendingPathComponent("Documents/Seshat")
    }

    /// Default config location (matches the Python app for cross-compat migration).
    public static var defaultConfigURL: URL {
        FileManager.default.homeDirectoryForCurrentUser
            .appendingPathComponent("Library/Application Support/Seshat/watcher-config.json")
    }
