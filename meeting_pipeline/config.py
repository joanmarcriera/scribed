...
DATA_BASE_DIR: Path = Path.home() / "Documents" / "Seshat"

DEFAULTS: dict = {
    "watch_interval_seconds": 20,
    "recordings_dir": "~/Documents/Seshat/recordings",
    "notes_dir": "~/Documents/Seshat/notes",
    "work_dir": "~/Library/Application Support/Seshat/work",
    "transcribe": {
...
def resolve_path(value: str) -> Path:
    ...
    values resolve under ``DATA_BASE_DIR`` (~/Documents/Seshat), never
